...
axis_frac=["ger","hun","ita","rom","fin","vf"]
red_frac=["sov"]
...
#scene_hq_mod(r"Unity of Command 2\_packages\dlc7\data\campaigns\fox.usc\scenarios\hgs\hqs.yml")
...
UoC2(r"Unity of Command 2\_packages\dlc7\data\campaigns\fox.usc\scenarios")
