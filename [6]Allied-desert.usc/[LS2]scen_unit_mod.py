...
id_list,country_list,faction_list,s_type_list,parent_list,gen_type=lut(r"Unity of Command 2\_packages\dlc6\data\campaigns\desert.usc\units.yml")
...
#unit_sgmnt(r"Unity of Command 2\_packages\dlc6\data\campaigns\desert.usc\scenarios\#####\units.yml")
...
#enroute_sgmnt(r"Unity of Command 2\_packages\dlc6\data\campaigns\desert.usc\scenarios\#####\enroute_units.yml")
