...
id_list,country_list,faction_list,s_type_list,parent_list,gen_type=lut("F:/Steam/steamapps/common/Unity of Command 2/_packages/base/data/campaigns/west.usc/units.yml")
