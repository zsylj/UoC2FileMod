...
def hq_id(path,hq_id_list):
    ...
    for item in temp:
        ...
        if item["template"][0:ind] in allied_frac and item["id"] not in hq_id_list:
...
def UoC2(uoc_dir):
    ...
    print("Final")
    print(hq_id_list)
UoC2(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\base\data\campaigns\france.usc\scenarios")#####
...
usc_main_mod(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\base\data\campaigns\france.usc\main.yml",hq_id_list)#####
