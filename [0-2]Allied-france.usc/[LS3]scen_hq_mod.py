...
def scene_hq_mod(path):
    ...
    for item in temp:
        ...
        if item["template"][0:ind] in allied_frac:
...
#scene_hq_mod(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\base\data\campaigns\france.usc\scenarios\unthinkable\hqs.yml")
