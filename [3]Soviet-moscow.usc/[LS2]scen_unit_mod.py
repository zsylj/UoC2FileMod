...
id_list,country_list,faction_list,s_type_list,parent_list,gen_type=lut("F:/Steam/steamapps/common/Unity of Command 2/_packages/dlc3/data/campaigns/moscow.usc/units.yml")
    ...
    for item in temp:
        ...
        if faction_list[ind]=="red":
            ...
            if gen_type[ind]=="type1":
                item["specs"]=[{'active': True, 'captured': False, 'idx': 8, 'type': 'sov_eng_41'}, {'active': True, 'captured': False, 'idx': 9, 'type': 'sov_nkvd_41'}, {'active': True, 'captured': False, 'idx': 10, 'type': 'sov_towed_gun_dlc3'}]
            else:
                item["specs"]=[{'active': True, 'captured': False, 'idx': 8, 'type': 'sov_armx_41_opt'}, {'active': True, 'captured': False, 'idx': 9, 'type': 'sov_heavy_tank_41_opt'}, {'active': True, 'captured': False, 'idx': 10, 'type': 'sov_towed_at_dlc3'}]
...
#unit_sgmnt(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\dlc3\data\campaigns\moscow.usc\scenarios\barvenkovo_offensive\units.yml")
...
def enroute_sgmnt(path):
    ...
    for item in temp:
        ...
        if faction_list[ind]=="red":
            ...
            item["unit"]["xp"]=300
            if gen_type[ind]=="type1":
                item["unit"]["specs"]=[{'active': True, 'captured': False, 'idx': 8, 'type': 'sov_eng_41'}, {'active': True, 'captured': False, 'idx': 9, 'type': 'sov_nkvd_41'}, {'active': True, 'captured': False, 'idx': 10, 'type': 'sov_towed_gun_dlc3'}]
            else:
                item["unit"]["specs"]=[{'active': True, 'captured': False, 'idx': 8, 'type': 'sov_armx_41_opt'}, {'active': True, 'captured': False, 'idx': 9, 'type': 'sov_heavy_tank_41_opt'}, {'active': True, 'captured': False, 'idx': 10, 'type': 'sov_towed_at_dlc3'}]
        elif faction_list[ind]=="axis":
            item["unit"]["act_st"]=0
            item["unit"]["sup_st"]=7
            item["unit"]["xp"]=0
...
#enroute_sgmnt(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\dlc3\data\campaigns\moscow.usc\scenarios\barvenkovo_offensive\enroute_units.yml")
...
def prepos_sgmnt(path):
    ...
    for item in temp:
        if item["faction"]=="axis":
            continue
        elif item["faction"]=="soviet" and item["type"]=="para_plane":
            ind=id_list.index(str(item["unit"]["id"]))
            item["unit"]["act_st"]=7
            item["unit"]["sup_st"]=0
            item["unit"]["xp"]=300
            item["unit"]["specs"]=[]
        elif item["faction"]=="soviet" and item["type"]=="lci":
            ind=id_list.index(str(item["unit"]["id"]))
            item["unit"]["act_st"]=7
            item["unit"]["sup_st"]=0
            item["unit"]["xp"]=300
