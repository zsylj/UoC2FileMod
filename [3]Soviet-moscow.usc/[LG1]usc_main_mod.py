...
def hq_id(path,hq_id_list):
    ...
    for item in temp:
        ...
        if item["template"][0:ind] in red_frac and item["id"] not in hq_id_list:
...
def UoC2(uoc_dir):
    ...
    print("Final")
    print(hq_id_list)
UoC2(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\dlc3\data\campaigns\moscow.usc\scenarios")
...
usc_main_mod(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\dlc3\data\campaigns\moscow.usc\main.yml",hq_id_list)
