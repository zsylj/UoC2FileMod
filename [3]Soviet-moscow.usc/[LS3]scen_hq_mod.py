...
def scene_hq_mod(path):
    ...
    for item in temp:
        ...
        if item["template"][0:ind] in red_frac:
...
#scene_hq_mod(r"F:\Steam\steamapps\common\Unity of Command 2\_packages\dlc3\data\campaigns\moscow.usc\scenarios\moscow_defensive\hqs.yml")
