...
id_list,country_list,faction_list,s_type_list,parent_list,gen_type=lut("_packages/base/data/campaigns/tutorial.usc/units.yml")
...
#unit_sgmnt(r"_packages\base\data\campaigns\tutorial.usc\scenarios\barvenkovo_offensive\units.yml")
...
#enroute_sgmnt(r"_packages\base\data\campaigns\tutorial.usc\scenarios\barvenkovo_offensive\enroute_units.yml")
...
temp=UoC2(r"_packages\base\data\campaigns\tutorial.usc\scenarios")
