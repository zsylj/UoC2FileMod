...
def lut(path):
    ...
    fraction_list=[]
    red_frac=["sov"]
    allied_frac=["us","bra","ff","uk","aus","can","gr","ind","nor","nz","pol","sa","yug","bel","fr","nl","swe","sws"]
    axis_frac=["ger","ss","cro","hun","ita","rom","rsi","svk","vf","bul","est","fin","spa"]
    for item in country_list:
        if item in red_frac:
            fraction_list.append("red")
        elif item in allied_frac:
            fraction_list.append("allied")
        else:
            fraction_list.append("axis")
    #print(fraction_list)
    ...
    f.closed
    return id_list,country_list,fraction_list,rr_type_list

id_list,country_list,fraction_list,rr_type_list=lut(r"D:/Program Files/Steam/steamapps/common/Unity of Command 2/_packages/dlc2/data/campaigns/barbarossa.usc/units.yml")
