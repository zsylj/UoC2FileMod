...
id_list,country_list,faction_list,s_type_list,parent_list,gen_type=lut(r"Unity of Command 2\_packages\dlc1\data\campaigns\blitzkrieg.usc\units.yml")
    ...
    for item in temp:
        ...
        if parent_list[ind]=="ger":
            ...
            if gen_type[ind]=="type1":
                ...
                item["specs"]=[{'active': True, 'captured': False, 'idx': 8, 'type': 'ger_asg_40'}, {'active': True, 'captured': False, 'idx': 9, 'type': 'ger_pzx_40'}, {'active': True, 'captured': False, 'idx': 10, 'type': 'ger_recon_39'}]
...
#unit_sgmnt(r"Unity of Command 2\_packages\dlc1\data\campaigns\blitzkrieg.usc\scenarios\fall_braun\units.yml")
